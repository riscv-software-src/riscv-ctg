def get_cond_generator(opcode,fmt,val_vars,xlen,flen):
    ...
    def fr16_generator(req_val_comb):
        def condition(*argv):
            rs1_val = argv[0]
            rs2_val = argv[1]
            rm = argv[2]
            ...
            fs1 = int(bin_val[0],2)
            fe1 = int(bin_val[1:6],2)
            fm1 = int(bin_val[6:],2)
            bin_val = '{:016b}'.format(rs2_val)
            fs2 = int(bin_val[0],2)
            fe2 = int(bin_val[1:6],2)
            fm2 = int(bin_val[6:],2)
            return eval(req_val_comb)
        return condition
    ...
    def fsr16_generator(req_val_comb):
        def condition(*argv):
            rs1_val = argv[0]
            rm = argv[1]
            bin_val = '{:016b}'.format(rs1_val)
    ...
    def fr4_16_generator(req_val_comb):
        def condition(*argv):
            rs1_val = argv[0]
            rs2_val = argv[1]
            rs3_val = argv[2]
...
def get_filter_generator(opcode,fmt,val_vars,xlen,flen):
    ...
    def fr16_generator(argv):
        bin_val1 = '{:016b}'.format(argv[0])
        bin_val2 = '{:016b}'.format(argv[1])
        local = {
        'rs1_val': argv[0]
        ,'rs2_val': argv[1]
        ,'rm': argv[2]
        ,'fs1': int(bin_val1[0],2)
        ,'fe1': int(bin_val1[1:6],2)
        ,'fm1': int(bin_val1[6:],2)
        ,'fs2': int(bin_val2[0],2)
        ,'fe2': int(bin_val2[1:6],2)
        ,'fm2': int(bin_val2[6:],2)
        }
        def filter_func(cond):
            return eval(cond,{},local)
        return filter_func
    ...
    def fr4_16_generator(argv):
        bin_val1 = '{:016b}'.format(argv[0])
        bin_val2 = '{:016b}'.format(argv[1])
        bin_val3 = '{:016b}'.format(argv[2])
        local = {
        'rs1_val': argv[0]
        ,'rs2_val': argv[1]
        ,'rs3_val': argv[2]
        ...
        ,'fm2': int(bin_val2[6:],2)
        ,'fs3': int(bin_val3[0],2)
        ,'fe3': int(bin_val3[1:6],2)
        ,'fm3': int(bin_val3[6:],2)
        }
        def filter_func(cond):
            return eval(cond,{},local)
        return filter_func
