...
#define TEST_CSR_FIELD_W_MASK(ADDRESS,TEMP_REG1,TEMP_REG2,MASK_VAL,VAL,DEST_REG,OFFSET,BASE_REG) \
  LI(TEMP_REG1,VAL);\
  LI(TEMP_REG2,MASK_VAL);\
  and TEMP_REG1,TEMP_REG1,TEMP_REG2;\
  csrr DEST_REG,ADDRESS;\
  not TEMP_REG2,TEMP_REG2;\
  and DEST_REG,DEST_REG,TEMP_REG2;\
  or TEMP_REG1,TEMP_REG1,DEST_REG;\
  csrrw TEMP_REG2,ADDRESS,TEMP_REG1;\
  csrr DEST_REG,ADDRESS;\
  csrw ADDRESS,TEMP_REG2;\
  RVTEST_SIGUPD(BASE_REG,DEST_REG,OFFSET)
